 ...
 * @author jose
 */
public class KokPointer {

    private static final String IMG_URL = "/com/jgranados/kok/ui/images/kok_pointer.png";
    ...
    public KokPointer(int posX, int posY, int angle, PanelDraw panelToDraw) {
        this.posX = posX;
        this.posY = posY;
        this.angle = angle;
        try {
            ...
            System.out.println("Error gettin the image");
        }
